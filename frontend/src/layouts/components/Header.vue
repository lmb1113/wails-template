    ...
    <t-head-menu :class="menuCls" :theme="menuTheme" expand-type="popup" :value="active">
      ...
      <template #operations>
        <div class="operations-container">
          ...
          <t-tooltip placement="bottom" :content="t('layout.header.minimise')">
            <t-button theme="default" shape="square" variant="text" @click="minimiseWindows">
              <t-icon name="remove" />
            </t-button>
          </t-tooltip>
<!--          <t-tooltip placement="bottom" :content="t('layout.header.maximise')">-->
<!--            <t-button theme="default" shape="square" variant="text" @click="maximiseWindows">-->
<!--              <t-icon name="rectangle" />-->
<!--            </t-button>-->
<!--          </t-tooltip>-->
          <t-tooltip placement="bottom" :content="t('layout.header.close')">
            <t-button theme="default" shape="square" variant="text" @click="closeWindows">
              <t-icon name="close" />
            </t-button>
          </t-tooltip>
        </div>
